...
!developmentChains.includes(network.name)
    ? describe.skip : describe("my test", () => {
        ...
        describe("borrowEthExample", () => {
            let tokenBase, tokenQuote, investmentAmount
            beforeEach(async () => {
                investmentAmount = 11
            ...
            it("print", async () => {   
                ...
                // await DAIWithUser.approve(myTestContractByUser.address, investmentAmount)
                await DAIWithUser.transfer(myTestContractByUser.address, investmentAmount)

                const cETHAddress = "0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5"
                const comptrollerAddress = "0x3d9819210A31b4961b30EF54bE2aeD79B9c9Cd3B"
                const cTokenDAIAddress = process.env.MAINNET_COMPOUND_CDAI_ADDRESS
                const underlyingAddress = await getUnderlyingByCTokenAddress(cTokenDAIAddress)
